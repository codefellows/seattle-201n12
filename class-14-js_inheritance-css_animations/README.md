...
#### The 301 entrance exam (and our final exam) will be published Thursday the 25th afternoon and will be due at 11:59pm on Sunday the 28th.

- Announcements
  - Project Week is almost here!!!
  - Today: Review project ideas
  - Next Monday Monday: During class you will do a GitHub exercise with your team and begin the planning process for your project.
  - Next Wednesday at the start of class: Submit your project plans to the instructional staff, we'll review them together (your team with the instructional team) to make sure everything is properly scoped and understood, and once approved, start building! **No code before then!**
...
**Q: Is it OK if multiple teams select the samee project?**

**A:** Yep.

**Q: Can teams come up with a new project idea and pivot to it over the weekend?**

**A:** Only with Nicholas's approval, which should be done via a direct message in Slack. Note that Nicholas is generally not on Slack a lot on weekends. Some, but not a lot, but usually responds within a few hours.
...
**A:** NO. The only exception is if there is need to create a technical proof-of-concept, and that exception must be recommended and/or approved by Nicholas.
